...
public class UserDAO {
    ...
    public UserDAO() {
        try {
            ...
            System.out.println("UserDAO: 数据库驱动文件异常");
            e.printStackTrace();
        }
    }
    ...
    public synchronized void deleteUser(int id) {
        ...
        try {
            ...
            System.out.println("UserDAO: deleteUser 删除数据异常");
            e.printStackTrace();
        }
    }
    ...
    public synchronized void updateUser(User user) {
        ...
        try {
            ...
            System.out.println("UserDAO: updateUser 更新数据异常");
            e.printStackTrace();
        }
    }
    ...
    public synchronized User selectUser(String name, String password) {
        ...
        try {
            ...
            System.out.println("UserDAO: selectUser 数据库查询数据发生异常");
            e.printStackTrace();
        }
        return user;
    }
    ...
    // 查询数据：遍历数据
    public synchronized List<User> selectUserList(int begin, int length) {
        // 定义 List<User> 集合对象
        ...
        try {
            ...
            System.out.println("UserDAO: selectUserList 遍历数据异常");
            e.printStackTrace();
        }
        return userList;
    }
